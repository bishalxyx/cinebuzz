...
export const Moviepage = () => {
    ...
    // console.log(movieId)
    const getmovie = () => {
        fetch(`https://api.themoviedb.org/3/movie/${param.id}?api_key=9c9543032d831fbc338e8a565c16266f`)
            ...
            <section className='bg-slate-500 flex flex-wrap justify-around dark:bg-gray-800 '>
                ...
                <div className='max-w-2xl text-gray-700 text-lg dark:text-white'>
                    ...
                    <div className="flex items-center">
                        ...
                        <p className="text-black ms-2 text-sm font-bold text-gray-900 dark:text-white">{movieList.vote_average}</p>
                        <span className="text-black w-1 h-1 mx-1.5 bg-gray-500 rounded-full dark:bg-gray-400"></span>
                        <span  className="text-black text-sm font-medium text-gray-900  hover:no-underline dark:text-white">{movieList.vote_count} reviews</span>
                    </div>
                    <p className='my-4'>
